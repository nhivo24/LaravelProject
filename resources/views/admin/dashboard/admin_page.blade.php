...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      <li><a href="/coupons"><em class="fa fa-percent">&nbsp;</em>Discount Code</a></li>


      <li class="parent"><a  onclick="show()"  href="#"><em class="fa fa-user">&nbsp;</em>User
      </a>
        <ul style="display: none;" id="users" >
          <li>
            <a class="" href="/admin/users/index">
            <span class="fa fa-arrow-right">&nbsp;</span>List User
          </a>
        </li>
         <li>
            <a class="" href="/list_orders">
      ...
      <li class="parent">
        <a  onclick="shownd()"  href="#">

        <em class="fa fa-navicon">&nbsp;</em> Product
        </a>
        <ul style="display: none;" id="product" >
          <li><a class="" href="/admin/product/index">
            <span class="fa fa-arrow-right">&nbsp;</span>List Product
          </a></li>
          <li><a class="" href="/admin/product/addProduct">
            <span class="fa fa-arrow-right">&nbsp;</span> Add Product
          </a></li>
        </ul>
      </li>
      <li><a href="/auth/logout"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
    </ul>
  </div><!--/.sidebar-->
  ...
  <script>
     ...
     function show(){
        var txt = document.getElementById('users');
        txt.style.display = 'block';
    }
  </script>
